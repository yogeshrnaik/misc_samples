...
public class Lesson1 {
    ...
    /**
     * All exercises should be completed using Lambda expressions and the new methods added to JDK 8 where appropriate. There is no need to
     * use an explicit loop in any of the code. Use method references rather than full lambda expressions wherever possible.
     */
    /**
